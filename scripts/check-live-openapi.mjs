...
const requiredOperations = [
  ...
  ['POST', '/api/v1/projects/{project_id}/requirements/upsert'],
  ...
  ['GET', '/api/v1/projects/{project_id}/agent-artifact/{artifact_id}/download'],
  ...
  ['GET', '/api/v1/quotes/history/samples/{sample_id}'],
  ...
  ['POST', '/api/v1/projects/{project_id}/check'],
  ['GET', '/api/v1/projects/{project_id}/check/{check_id}'],
  ['POST', '/api/v1/projects/{project_id}/export'],
  ['GET', '/api/v1/projects/{project_id}/export/{job_id}'],
  ['GET', '/api/v1/projects/{project_id}/delivery-package'],
